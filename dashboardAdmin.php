...
<section class="grid section-user">
    <div class="user-left">
      ...
      <a class="profile-bellow" href="available_admin.php">Update Mechanic</a>
      </div>
      <div class="profile-bellow-main">
      <a class="profile-bellow" href="historyAdmin.php">All Appointment History</a>
      </div>
    </div>
...
echo $row_count;?> | Last Updated: <span class="second-span"></span></p>
      </div>
